...
\newimage[\textwidth]{images/comb-circuit.png}{مدار محاسباتی}{fig:comb-circuit}
...
\newimage[\textwidth]{images/delay-sim.png}{شکل موج خروجی شبیه‌سازی‌ها به ازای تمام \lr{Transition}ها}{fig:delay-sim}
...
\newimage[\textwidth]{images/comb-circuit-2.png}{مدار محاسباتی}{fig:comb-circuit-2}
