...
\newimage[\textwidth]{images/comb-circuit/comb-circuit-3.png}{مدار محاسباتی}{fig:comb-circuit-3}

\newimage[\textwidth]{images/comb-circuit/delay-sim2.png}{شکل موج خروجی شبیه‌سازی‌ها به ازای تمام \lr{Transition}ها}{fig:delay-sim2}
